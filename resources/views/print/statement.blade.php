...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        td { padding: 2.2mm 2mm; border-bottom: 0.5pt solid #e2e8f0; vertical-align: top; }
        .num { text-align: right; font-variant-numeric: tabular-nums; }
        .ref { font-variant-numeric: tabular-nums; font-weight: 600; }

        .totals { margin-left: auto; width: 70mm; margin-top: 5mm; font-size: 9.5pt; }
        ...
        .foot { display: flex; justify-content: space-between; align-items: flex-end; gap: 10mm; border-top: 0.5pt solid #cbd5e1; margin-top: auto; padding-top: 4mm; font-size: 7.5pt; color: #94a3b8; }
