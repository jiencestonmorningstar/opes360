...
<div class="px-5 pb-8 lg:px-6 lg:pt-6">
    ...
    <div class="flex items-center justify-between gap-4">
        ...
        @can('expenses.create')
            <button type="button" wire:click="startRecording"
                ...
                <span class="sr-only min-[420px]:not-sr-only">Record</span>
            </button>
        @endcan
    </div>
    ...
    <div class="no-scrollbar -mx-5 mt-4 flex gap-2 overflow-x-auto px-5 lg:mx-0 lg:px-0" role="group" aria-label="Filter expenses">
