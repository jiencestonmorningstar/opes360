...
return [
    ...
    'navigation' => [
        ...
        ['key' => 'manufacturing', 'label' => 'Manufacturing', 'icon' => 'cube', 'route' => 'manufacturing', 'ability' => 'manufacturing.view'],
        ['key' => 'orders', 'label' => 'Sales orders', 'icon' => 'cube', 'route' => 'orders', 'ability' => 'orders.view'],
        ['key' => 'insurance', 'label' => 'Insurance', 'icon' => 'shield-check', 'route' => 'insurance', 'ability' => 'insurance.view'],
        ['key' => 'estate', 'label' => 'Properties', 'icon' => 'briefcase', 'route' => 'estate', 'ability' => 'estate.view'],
        ['key' => 'logistics', 'label' => 'Shipments', 'icon' => 'briefcase', 'route' => 'logistics', 'ability' => 'logistics.view'],
        ['key' => 'replenishment', 'label' => 'Running low', 'icon' => 'cube', 'route' => 'stock.replenishment', 'ability' => 'products.view'],
        ...
        ['key' => 'claims', 'label' => 'My claims', 'icon' => 'banknotes', 'route' => 'expenses.claims', 'ability' => 'expenses.claim-view'],
        ['key' => 'fleet', 'label' => 'Fleet', 'icon' => 'briefcase', 'route' => 'assets.fleet', 'ability' => 'assets.view'],
        ['key' => 'payable-runs', 'label' => 'Payment runs', 'icon' => 'banknotes', 'route' => 'payables.runs', 'ability' => 'payables.view'],
        ['key' => 'collections', 'label' => 'Collections', 'icon' => 'chart-bar', 'route' => 'reports.collections', 'ability' => 'reports.view'],
        ['key' => 'statements', 'label' => 'Statements', 'icon' => 'chart-bar', 'route' => 'reports.statement', 'ability' => 'reports.view'],
        ['key' => 'paper-analytics', 'label' => 'Document analytics', 'icon' => 'chart-bar', 'route' => 'papers.analytics', 'ability' => 'papers.manage'],
        ['key' => 'governance', 'label' => 'Governance', 'icon' => 'shield-check', 'route' => 'audit.governance', 'ability' => 'audit.govern'],
        ['key' => 'notification-rules', 'label' => 'Notification rules', 'icon' => 'cog', 'route' => 'settings.notification-rules', 'ability' => 'notifications.manage'],
        ['key' => 'my-notifications', 'label' => 'My notifications', 'icon' => 'cog', 'route' => 'settings.notifications'],
